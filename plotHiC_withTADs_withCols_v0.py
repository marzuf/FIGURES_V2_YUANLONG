...
#tad_file = "ENCSR489OCU_NCI-H460_40kb_coord_chr11.txt"  # can be 2-col or 3-col chr11_TAD390
tad_file = "ENCSR489OCU_NCI-H460_40kb_coord_chr10.txt"  # can be 2-col or 3-col chr10_TAD268
plot_labs = True
...
# OUTFILE 
output_file = "PLOTHIC_WITHTADS_WITHCOLS/ENCSR489OCU_NCI-H460_40kb_chr11_TAD390.pdf"
output_file = "PLOTHIC_WITHTADS_WITHCOLS/ENCSR489OCU_NCI-H460_40kb_chr10_TAD268.pdf"
...
col_list = ([other_col] * nAround_toplot) + [select_col] + ([other_col] * nAround_toplot)

assert len(start_pos_list) == len(end_pos_list) == len(lab_list) == len(col_list)
